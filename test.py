...
def get_opt():
    ...
    parser.add_argument("--init_type", type=str, default="normal", help="…")
    parser.add_argument("--init_variance", type=float, default=0.02, help="…")
    ...
    parser.add_argument(
        ...
        type=str,
        default="test",
        help="which subfolder under dataset_dir to use (e.g. 'test')"
    )
